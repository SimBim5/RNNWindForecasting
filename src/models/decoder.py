...
class MultiSeriesDecoder(nn.Module):
    def __init__(self, hidden_size, num_series, num_layers, num_directions, prediction_length, spatial_feature_size):
        ...
        self.lstm = nn.LSTM(self.num_series + self.hidden_size * self.num_directions + self.hidden_size * self.num_directions, self.hidden_size * self.num_directions, self.num_layers, batch_first=True)
